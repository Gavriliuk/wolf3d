...
utils = {
 ...
 extend: function(a, b) {
  for(var c in b) void 0 == a[c] ? null != b[c] && void 0 != b[c] && "object" == typeof b[c] ? (a[c] = "number" == typeof b[c].length ? [] : {}, utils.extend(a[c], b[c])) : a[c] = b[c] : "object" == typeof b[c] && utils.extend(a[c], b[c])
 },
...
resources = {
 ...
 init: function(a, b) {
  ...
  c || (c = document.createElement("DIV"), c.id = "resources", document.body.appendChild(c), c = document.getElementById("resources"));
  resources.count = 0;
  ...
  for(d in resources.textures) "string" == typeof resources.textures[d] && (resources[d] ? (resources.count--, !resources.count && a && a()) : (c = new Image, c.id = d, c.onload = function() {
   var b = floor((this.width || this.naturalWidth) / resources.textureWidth),
    c = floor((this.height || this.naturalHeight) / resources.textureHeight);
   resources[this.id] = [];
   for(var d = 0; d < b; d++) {
    resources[this.id][d] = [];
 ...
 Texture: function(a, b, c) {
  ...
  this.context.drawImage(a, b * resources.textureWidth, c * resources.textureHeight, resources.textureWidth, resources.textureHeight, 0, 0, this.canvas.width, this.canvas.height);
...
audio = {
 ...
 init: function(a) {
  ...
  b && (audio.canPlay = !!b.canPlayType, audio.canPlay && (audio.canPlayMP4 = b.canPlayType("audio/mpeg"), audio.musicVolume = a.musicVolume || 0, audio.soundsVolume = a.soundsVolume || 0))
 },
 ...
 stopMusic: function() {
  audio.currentMusic && (audio.musicChannel.pause(), document.body.removeChild(audio.musicChannel), audio.musicChannel = null, audio.currentMusic = null)
 },
    ...
    if((c ? e : 1) && f)
     ...
     if(d)
      if(c) {
       ...
       e && (e.gain = audio.context.createGainNode(), e.src = audio.context.createBufferSource(), e.src.buffer = d, e.src.connect(e.gain), e.gain.connect(audio.context.destination), e.gain.gain.value = (null == b || void 0 == b ? 1 : b) * audio.soundsVolume, e.src.noteOn(0))
      } else {
...
sprites = {
 Sprite: function(a) {
  ...
  this.listeners = {};
  if(a.listeners)
   for(var b in a.listeners) this.listeners[b] = utils.bind(this, a.listeners[b])
 }
};
...
doors.Door.prototype = {
 ...
 close: function() {
  this.delayTimer && delete this.delayTimer;
  this.action = "open";
  this.process = utils.bind(this, function() {
 ...
 getTexture: function(a) {
  "silver" == this.key ? a = 1 : "gold" == this.key && (a = 0);
...
secret.SecretWall.prototype = {
 ...
 move: function() {
  ...
  var a = this.map.getHitValue(this.x + this.direction.x, this.y + this.direction.y);
...
scripts.Script.prototype = {
 ...
 endgame: function(a) {
  a.score && (document.getElementById("hand").style.display = "none", a.map.ai.push(new ai.BJ({
   ...
   a.getDistance(game.bj.x, game.bj.y) > 2 * sqrt2 && (game.bj.direction = {
    x: -1,
    y: 0
   });
 ...
 Map: function(a, b) {
  ...
  if(a.doors)
   for(c = 0; c < a.doors.length; c++) {
    ...
    this.doors[d.x][d.y] = new doors.Door(d)
   }
  this.sprites = [];
  this.spriteHistory = {
   add: [],
...
maps.Map.prototype = {
 generateHitMap: function() {
  ...
  for(d = 0; d < this.secrets.length; d++) e = this.secrets[d], this.secretMap[e.x][e.y] = e
 },
 getGraph: function() {
 ...
 getHitValue: function(a, b, c) {
  ...
  if(c && c.hit)
   for(var e = 0; e < this.ai.length; e++) {
    var f = this.ai[e];
    if(!(c && c.id == f.id) && f.baseX == a && f.baseY == b && f.hitpoints) {
     d = !0;
     break
    }
   }
  ...
  for(var c = -1; 2 > c; c++)
   for(var d = -1; 2 > d; d++) {
    for(var e = this.hit[a] && this.hit[a][b] ? 0 < this.hit[a][b] : !1, f = this.getDoor(a + c, b + d), h = !1, g = 0; g < this.ai.length; g++) {
     var j = this.ai[g];
     if(j.baseX == a + c && j.baseY == b + d && j.hitpoints) {
      h = !0;
      break
     }
    }
 ...
 isFree: function(a, b) {
  ...
  for(d = 0; d < this.ai.length; d++)
   if(e = this.ai[d], abs(e.x + 0.5 - a) <= this.hitDistance / 5 && abs(e.y + 0.5 - b) <= this.hitDistance / 5 && e.hitpoints) {
    c = !0;
    break
   }
  return c ? !1 : !0
 ...
 getSecret: function(a, b, c) {
  ...
  if(!d && !e && !f && !h && !g || void 0 != c && (c == d || c == e || c == f || c == h || c == g)) return null;
  ...
  if(!d) {
   ...
   if(g) return g.process && 0 == g.direction.y && (c = this.getMapValue(a, b), a = this.getSecret(a, b, g), !c && !a) ? (g.hidden = !0, g) : null
  }
 },
 ...
 getTexture: function(a, b, c, d, e) {
  return 0 == c && (d ? 0 > d ? this.getDoor(a + 1, b) : this.getDoor(a - 1, b) : this.getDoor(a - 1, b) || this.getDoor(a + 1, b)) || 1 == c && (e ? 0 > e ? this.getDoor(a, b + 1) : this.getDoor(a, b - 1) : this.getDoor(a, b - 1) || this.getDoor(a, b + 1)) ? resources.walls[66][c].canvas : (a = this.getMapValue(a, b)) ? resources.walls[a - 1][c].canvas : resources.walls[22][c].canvas
 },
...
player.Weapon.prototype = {
 ...
 renderHud: function() {
  ...
  this.hudContext.drawImage(resources.hudWeapon, 96 * this.id, 0, 96, 48, 0, 0, this.hudCanvas.width, this.hudCanvas.height)
 }
};
player.Keys.prototype = {
 render: function() {
  ...
  this.keys.silver ? this.context.drawImage(resources.hudKeys, 32, 0, 16, 32, 0, this.canvas.height / 2, this.canvas.width, this.canvas.height / 2) : this.context.drawImage(resources.hudKeys, 0, 0, 16, 32, 0, this.canvas.height / 2, this.canvas.width, this.canvas.height / 2)
 },
 has: function(a) {
  return this.keys[a]
 },
...
player.Face.prototype = {
 ...
 process: function(a) {
  if(!this.smile && !this.zombie && (0 < a.health ? (a = min(6, max(0, 6 - floor(a.health / (a.max.health / 7)))), this.level != a && (this.level = a, this.render())) : (this.faceTimer && (clearTimeout(this.faceTimer), delete this.faceTimer), this.level = 7, this.direction = 0, this.render()), !this.faceTimer && 7 > this.level)) this.faceTimer = setTimeout(utils.bind(this, function() {
...
player.Player.prototype = {
 ...
 setProperty: function(a, b) {
  ...
  var c = !1;
  0 < b ? this[a] < this.max[a] ? (this[a] = min(this.max[a], this[a] + b), c = !0) : c = !1 : this[a] > this.min[a] ? (this[a] = max(this.min[a], this[a] + b), c = !0) : c = !1;
 ...
 strafeLeft: function() {
  ...
  this.map.isFree(this.x + 1.5 * a * this.speed.move * game.timeFactor, this.y) && (this.x += 1.5 * a * this.speed.move * game.timeFactor);
 ...
 script: function() {
  if(!game.editor && (floor(this.prevX) != floor(this.x) || floor(this.prevY) != floor(this.y))) {
 ...
 door: function() {
  ...
  else if(0 == secret.process.length && (d = this.map.getSecret(b, c)) && !d.hidden && !d.process) {
  ...
  22 == this.map.getMapValue(b, c) && -1 != this.map.floors[b][c] && (this.map.map[b][c] = 24, 107 == this.map.floors[floor(this.x)][floor(this.y)] && (this.secretfound = !0), audio.playSound("leveldone"), this.leveldone = !0, a = !1);
 ...
 weapon: function(a) {
  ...
  if(this.getActiveWeapon().id != a) {
   ...
   return c && c.ammo && 0 == this.ammo ? (c.active = !1, b.active = !0, this.activeWeapon = b, this.activeWeapon.render(), !1) : !0
  }
  return !1
 },
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dying: new animation.Animation({
     ...
     single: !0,
     callback: utils.bind(this, function(a) {
      1 == a.index && (audio.queueSound("meingott", this.baseX, this.baseY), a.speed = 100);
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dying: new animation.Animation({
     ...
     single: !0,
     callback: utils.bind(this, function(a) {
      1 == a.index && (audio.queueSound("eva", this.baseX, this.baseY), a.speed = 100);
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dying: new animation.Animation({
     ...
     single: !0,
     callback: utils.bind(this, function(a) {
      1 == a.index && (audio.queueSound("rose", this.baseX, this.baseY), a.speed = 100);
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dying: new animation.Animation({
     ...
     single: !0,
     callback: utils.bind(this, function(a) {
      1 == a.index && audio.queueSound("wilhelmdeath", this.baseX, this.baseY);
      3 == a.index && this.animate("dead")
     })
    }),
    dead: new animation.Animation({
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dead: new animation.Animation({
     ...
     callback: utils.bind(this, function() {
      this.hitpoints = 0;
      this.dead && this.action ? this.action = this.dead : (this.action = null, setTimeout(utils.bind(this, function() {
  ...
  utils.extend(a, {
   ...
   animations: {
    ...
    dying: new animation.Animation({
     ...
     single: !0,
     callback: utils.bind(this, function(a) {
      1 == a.index && (audio.queueSound("dogdeath", this.baseX, this.baseY), scripts.process.push({
       x: this.baseX,
       y: this.baseY,
       action: "attack"
      }));
...
utils.overwrite(ai.Entity.prototype = Object.create(sprites.Sprite.prototype), {
 ...
 moveForward: function(a, b) {
  ...
  if(this.reset && this.action == this.moving) {
  ...
  if(!this.reset) {
   ...
   if("dog" != this.type && "fake" != this.type)
    if(this.action == this.attack) {
     if("walk" == this.animations.current || "run" == this.animations.current || "ready" == this.animations.current) {
    ...
    if((e = c.getDoor(this.baseX + this.direction.x, this.baseY + this.direction.y)) && !e.isOpen() && "open" == e.action) e[e.action]();
   ...
   if(d) {
    if("walk" == this.animations.current || "run" == this.animations.current || "ready" == this.animations.current) this.x += this.direction.x * (this.speed / this.detailLevel) * game.timeFactor, this.y += this.direction.y * (this.speed / this.detailLevel) * game.timeFactor, this.detailX += abs(floor(this.direction.x * this.speed * game.timeFactor)), this.detailY += abs(floor(this.direction.y * this.speed * game.timeFactor))
 ...
 checkAttack: function(a) {
  ...
  if(106 != c && !this.instantAttack)
   ...
   }!b && this.isVisible(a.x, a.y, a.map) && (this.lookingAt(a.x, a.y) || this.instantAttack || this.getDistance(a.x, a.y) <= sqrt2) ? (this.timer ? this.timer++ : this.timer = 1, this.attack(a)) : this.timer = 0
 },
 ready: function(a) {
 ...
 damage: function(a) {
  if(this.hitpoints && "dead" != this.animations.current && this.isVisible(a.x, a.y, a.map)) {
   var b = 0;
   ...
   b && (this.action != this.attack && this.action != this.fire && (b <<= 1), this.hitpoints -= b, 0 > this.hitpoints && (this.hitpoints = 0), this.hitpoints ? this.animations.hit && this.animate("hit") : this.animate("dying"), this.action = this.attack)
  }
 },
 process: function(a) {
...
utils.overwrite(ai.Fireball.prototype = Object.create(ai.Entity.prototype), {
 attack: function(a) {
  ...
  if(a.map.getMapValue(this.baseX, this.baseY) || this.baseX == floor(a.x) && this.baseY == floor(a.y))
   if(a.map.removeAI(this), ai.process.splice(ai.process.indexOf(this), 1), this.baseX == floor(a.x) && this.baseY == floor(a.y)) {
    var b = floor((utils.random(255) >> 3) / 3);
    game.difficulty || (b >>= 1);
    b && (a.setProperty("health", -b), 0 >= a.health && (a.deathCam = this), wolf3d.utils.flashHit())
   }
 }
...
utils.overwrite(ai.Orb.prototype = Object.create(ai.Entity.prototype), {
 attack: function(a) {
  ...
  if(a.map.getMapValue(this.baseX, this.baseY) || this.baseX == floor(a.x) && this.baseY == floor(a.y))
   if(a.map.removeAI(this), ai.process.splice(ai.process.indexOf(this), 1), this.baseX == floor(a.x) && this.baseY == floor(a.y)) {
    var b = floor(utils.random(255) >> 3);
    game.difficulty || (b >>= 1);
    b && (a.setProperty("health", -b), 0 >= a.health && (a.deathCam = this), wolf3d.utils.flashHit())
   }
 }
 ...
 attack: function(a) {
  if(0 > this.timer || 5 < this.timer || this.action == this.attack) {
   ...
   if("dying" == this.animations.current || "dead" == this.animations.current) this.animate(this.animations.current);
    ...
    this.reset ? (this.direction = e ? this.selectDodgeDirection(a.x, a.y, a.map) : this.selectChaseDirection(a.x, a.y, a.map), this.calculateAngle()) : 0 == this.direction.x && 0 == this.direction.y && (this.direction = this.selectDodgeDirection(a.x, a.y, a.map), this.calculateAngle());
    this.timer > ai.tick && ("walk" == this.animations.current || "run" == this.animations.current || "ready" == this.animations.current) && this.moveForward(a, "run");
    this.action != this.attack && this.action != this.fire && this.soundOnAttack && (audio.queueSound(this.soundOnAttack, this.baseX, this.baseY), scripts.process.push({
     x: this.baseX,
     y: this.baseY,
...
wolf3d = {
 ...
 utils: {
  ...
  addon: function(a, b, c, d, e, f, h) {
   return {
    ...
    listeners: {
     hit: function(a) {
      d && a.setProperty(c, d) && (h && h.call(a), f && audio.playSound(f, null, !0), wolf3d.utils.flashAddon(), a.map.removeSprite(this))
     }
    }
   }
  },
     ...
     callback: function(a) {
      ...
      if(a.index == a.count - 1) {
       ...
       for(a = 1; a < wolf3d.graphics.width / 8; a++) {
        ...
        if((b = this.fireBuffer[wolf3d.graphics.width / 2 - a]) && b.damage && 2 > this.getDistance(b.x, b.y)) {
         b.damage(this, 25 + floor(a / 2));
         break
        }
       }
 ...
 goldKey: function(a, b) {
  return {
   ...
   y: b,
   texture: 20,
   eval: utils.eval("wolf3d.goldKey", arguments),
   listeners: {
    hit: function(a) {
 ...
 firstAidKit: function(a, b) {
  return wolf3d.utils.health(a, b, 25, 25, "health2")
 },
 cross: function(a, b) {
 ...
 extraLife: function(a, b) {
  return {
   ...
   listeners: {
    hit: function(a) {
     a.setProperty("lives", 1) && (a.setProperty("health", 100), audio.playSound("bonus1up", null, !0), wolf3d.utils.flashAddon(), a.map.removeSprite(this))
    }
   }
  }
 },
 ...
 deadGuard: function(a, b) {
  return {
   ...
   x: a,
   y: b,
   eval: utils.eval("wolf3d.deadGuard", arguments),
   animations: {
    current: "dead"
   }
  }
 ...
 ssStanding: function(a, b, c, d) {
  return {
   ...
   level: d || 1,
   action: "ready",
   eval: utils.eval("wolf3d.ssStanding", arguments),
   animations: {
    current: "ready"
   }
  }
 ...
 officerMoving: function(a, b, c, d) {
  return {
   ...
   level: d || 1,
   action: "moving",
   eval: utils.eval("wolf3d.officerMoving", arguments),
   animations: {
    current: "run"
   }
  }
 ...
 dog: function(a, b, c, d) {
  return {
   ...
   level: d || 1,
   action: "moving",
   eval: utils.eval("wolf3d.dog", arguments),
   animations: {
    current: "run"
   }
  }
 ...
 uberMutant: function(a, b) {
  return {
   ...
   level: 0,
   action: "ready",
   eval: utils.eval("wolf3d.uberMutant", arguments),
   animations: {
    current: "ready"
   }
  }
   ...
   e.onload = utils.bind(d, function() {
    for(var d = 0; d < a.map.length; d++)
     if(a.map[d]) {
      ...
      c.drawImage(e, a.map[d].offset, 0, a.map[d].width, a.height, 0, 0, b.width, b.height);
      this.images[d] = {
       width: b.width,
       height: b.height,
       data: b.toDataURL()
  ...
  window.addEventListener("load", function() {
   for(var f = 0; f < a.length; f++)
    if(a[f]) {
     ...
     h || (h = document.createElement("DIV"), h.id = "resources", document.body.appendChild(h), h = document.getElementById("resources"));
     g = new Image;
...
raycast = {
 ...
 Engine: function(a) {
  ...
  this.canvas.width = this.width;
  this.canvas.height = this.height;
  a.webgl ? (WebGL2D.enable(this.canvas), this.context = this.canvas.getContext("webgl-2d")) : this.context = this.canvas.getContext("2d");
...
raycast.Engine.prototype = {
 ...
 backgroundRender: function() {
  ...
  this.backgroundContext.fillRect(0, 0, this.width, this.height / 2);
 ...
 fizzleFade: function() {
  ...
  for(var a = min(round(this.maskIndex + this.maskSpeed * game.timeFactor), this.mask.length - 1), b = this.maskIndex; b <= a; b++) {
   var c = this.mask[b];
 ...
 cast: function() {
  ...
  for(var b = [], c = 0; c < this.width; c++) {
   ...
   for(var t, f = !1; !f;) {
    ...
    if(f = this.map.getSecret(m, l)) k = !f.hidden && !f.shift ? f.state : 0, u = f.hidden, e.push(0 == t ? {
     ...
     perspectiveDistance: abs((l - g + (0 < i ? k : -k) + (1 - s) / 2) / i),
     x: m,
     y: l + (0 < i ? k : -k),
     side: t,
     secret: f,
   ...
   for(f = 0; f < d.length; f++)
    if(k = d[f], k.perspectiveDistance < p && (n = abs(floor(this.height / k.perspectiveDistance)), q = -n / 2, o = n / 2, n = o - q, q += this.height / 2, o += this.height / 2, o = 0 == k.side ? g + (k.x - h + (1 - r) / 2) / j * i : h + (k.y - g + (1 - s) / 2) / i * j, o -= floor(o), o = floor(o * resources.textureWidth), o > k.door.slide && !this.zBuffer[c])) {
   ...
   for(f = 0; f < d.length; f++)
    if(k = d[f], k.perspectiveDistance < p) {
     ...
     if(!this.zBuffer[c] || k.perspectiveDistance < this.zBuffer[c]) {
      k.hidden || (this.zBuffer[c] = k.perspectiveDistance, this.verticalContext.context.drawImage(k.secret.getTexture(k.side), n, 0, 1, resources.textureHeight, c, e, 1, q));
      break
     }
    }
   if(!this.zBuffer[c]) {
    ...
    f && (this.verticalContext.context.drawImage(f, h, 0, 1, resources.textureHeight, c, k, 1, d), this.verticalShading && this.verticalContext.context.drawImage(this.shaderImage, 0, this.calculateShader(), 1, 1, c, k, 1, d))
   }
  }
  ...
  for(f = 0; f < b.length; f++)
   if(k = b[f], j = k.x - this.player.x + 0.5, t = k.y - this.player.y + 0.5, i = 1 / (this.player.plane.x * this.player.direction.y - this.player.direction.x * this.player.plane.y), c = i * (-this.player.plane.y * j + this.player.plane.x * t), 0 < c) {
    ...
    k.center = r + (g - r) / 2;
    m = [];
    for(l = 0; r < g; r++) c < this.zBuffer[r] ? (k.visibleWidth++, s = min(resources.textureWidth, max(0, floor((r - (-h / 2 + j)) * resources.textureWidth / h))), m[l] ? (m[l].stripeRight = r, m[l].texRight = s) : m[l] = {
     stripeLeft: r,
     texLeft: s
    }, k.hitpoints && (this.player.fireBuffer[r] = k)) : m[l] && l++;
    for(l = 0; l < m.length; l++) l = m[l], l.stripeRight || (l.stripeRight = l.stripeLeft + 1, l.texRight = l.texLeft + 1), this.verticalContext.context.drawImage(k.texture, l.texLeft + (k.animations.current ? k.animations[k.animations.current].state + (k.animations[k.animations.current].slide ? k.getTextureSlide() : 0) : 0), 0, max(1, l.texRight - l.texLeft), resources.textureHeight, l.stripeLeft, t, max(1, l.stripeRight - l.stripeLeft), i)
   }
  ...
  b = (new Date).getTime();
  this.frameTime = b - a;
  1E3 < b - this.fpsStart ? (this.fps = this.fpsCounter, this.fpsCounter = 0, this.fpsStart = null) : this.fpsCounter ? this.fpsCounter++ : this.fpsCounter = 1
 }
};
controller = {
 keys: {
...
controller.Controller.prototype = {
 ...
 process: function() {
  ...
  for(a in this.inactiveKey) this.inactiveKey[a] && (this.inactiveListeners[a] ? this.inactiveKey[a] = !this.inactiveListeners[a]() : delete this.inactiveKey[a])
 }
};
game = {
 tick: 1E3 / 33,
 ...
 gameLoop: function() {
  if(game.pause) {
   if(game.win) {
    ...
    if(game.average) {
     ...
     }, game.client.total.kill || (game.average.kill = 100), game.client.total.secret || (game.average.secret = 100), !game.client.total.treasure) game.average.treasure = 100;
    game.win = null;
    window.onfocus = null;
    game.loop = null;
    ...
    game.hideScreen("game", function() {
     ...
     game.bitmap.text(document.querySelector("#wingamescreen .total"), "TOTAL TIME");
     ...
     game.bitmap.text(document.querySelector("#wingamescreen .secret"), "  SECRET " + utils.fillString(game.average.secret.toString(), " ", 3) + "%");
  ...
  if(game.client.leveldone) {
   ...
   !game.secretFloor && !game.levelConfig.endscreen ? (game.bitmap.text(e, "FLOOR " + q), game.bitmap.text(document.querySelector("#endlevelscreen .completed"), "COMPLETED"), game.bitmap.text(g, "BONUS " + utils.fillString("0", " ", 5)), game.bitmap.text(j, "TIME " + utils.fillString(b.toString(), "0", 2) + ":" + utils.fillString(c.toString(), "0", 2)), game.bitmap.text(i, " PAR " + utils.fillString(f.toString(), "0", 2) + ":" + utils.fillString(h.toString(), "0", 2)), game.bitmap.text(m, "    KILL RATIO   0%"), game.bitmap.text(l, "  SECRET RATIO   0%"), game.bitmap.text(p, "TREASURE RATIO   0%"), game.hideScreen("game", function() {
                ...
                c = setInterval(function() {
                 if(b == game.client.ratio.treasure) {
                  ...
                  if(game.average) {
                   ...
                   if(game.client.total.kill) game.average.kill = floor((game.average.kill + floor(game.client.ratio.kill / game.client.total.kill * 100)) / 2);
                   ...
                   secret: floor(game.client.ratio.secret / game.client.total.secret * 100),
    ...
    game.bitmap.text(document.querySelector("#secretlevelscreen .completed"), game.levelConfig.endscreen ? game.endscreenSubtitle[game.levelConfig.endscreen] : "COMPLETED!");
  ...
  if(game.death)
  ...
  else game.restart && (game.roster ? audio.currentMusic || (window.onkeydown = window.onclick = null, game.win = null, game.pause = !0, game.loop = null, game.hideScreen("game", function() {
   ...
   for(f = 0; f < doors.process.length; f++)
    if(e = doors.process[f], game.client.map.inDoor(game.client.x, game.client.y) || !(e.isOpen() && "open" == e.action)) {
     j = !1;
   ...
   for(scripts.process = []; audio.process.length;) h = audio.process.pop(), e = game.client.getDistance(h.x, h.y), f = utils.round(min(1, max(0, 25 - e) / 25), 1), 0.1 < f && audio.playSound(h.id, f, !0);
       ...
       game.ctrl = new controller.Controller({
        ...
        activeListeners: {
         viewInc: function() {
          ...
          localStorage.zoom = localStorage.zoom ? (round(localStorage.zoom * 100) + 1) / 100 : 1.01;
         ...
         left: utils.bind(game.client, function() {
          game.client.left();
          return false
         }),
         ...
         backward: utils.bind(game.client, function() {
 ...
 showScreen: function(a, b, c) {
  ...
  game.requestHTML(a, function() {
   ...
   game.activeScreen = a;
   b ? game.timeout = setTimeout(function() {
    game.timeout = null;
 ...
 highscores: function() {
  ...
  game.requestHTML("highscores", function() {
   ...
   var b = document.querySelector("#highscores .rows");
   b.innerHTML = "";
   for(var c = 0; 7 > c; c++) {
 ...
 difficultyMenu: ["Can I play, Daddy?", "Don't hurt me.", "Bring 'em on!", "I am Death incarnate!"],
 difficultyCtrl: function(a) {
  ...
  if(40 == a.keyCode || 38 == a.keyCode) {
   ...
   document.getElementById("difficultypicture").style.backgroundPosition = "0px " + 96 * -b.cursorIndex + "px";
  ...
  }, 500)) : 27 == a.keyCode && (window.onkeydown = window.onclick = null, audio.playSound("escpressed"), game.hideScreen("difficulty", game.episode))
 },
 difficultySelection: function() {
  game.showScreen("difficulty", null, function() {
    ...
    c.onmousemove = function() {
     if("difficulty" == game.activeScreen) {
      ...
      if(a.cursorIndex != this.index) {
       ...
       a.style.marginTop = 36 * a.cursorIndex + "px"
      }
     }
    };
    c.onmouseup = function(a) {
   ...
   window.onmouseup = function(a) {
    if("difficulty" == game.activeScreen && (a || (a = window.event), 0 != a.button)) window.onkeydown = window.onclick = null, audio.playSound("escpressed"), game.hideScreen("difficulty", game.episode)
   };
   c = a[2];
 ...
 episodeCtrl: function(a) {
  ...
  if(40 == a.keyCode || 38 == a.keyCode) {
   ...
   game.largeText.text(h, "Episode " + (c.cursorIndex + 1));
   ...
   switch(a.keyCode) {
    ...
    case 38:
     ...
     for(h = !1; - 1 < e[2 * c.cursorIndex].className.search("disabled");) h = !0, c.cursorIndex--, 0 > c.cursorIndex && (c.cursorIndex = f - 1);
     audio.playSound(h ? "movegun2" : "movegun1");
     b = !0
   }
   h = e[2 * c.cursorIndex];
  ...
  } else 13 == a.keyCode ? (audio.playSound("shoot"), window.onkeydown = window.onclick = null, game.loop ? (game.showMessage(game.curgameStr), window.onkeydown = function(a) {
   if(!a) a = window.event;
   switch(a.keyCode) {
    case 89:
    case 90:
  ...
  }) : (game.mapName = "e" + (c.cursorIndex + 1) + "m1", game.hideScreen("episode", game.difficultySelection))) : 27 == a.keyCode && (window.onkeydown = window.onclick = null, audio.playSound("escpressed"), game.hideScreen("episode", game.loop ? game.gameMenu : game.menu));
   ...
   for(a = 0; a < b.length; a++) {
    ...
    c.onmouseup = function(a) {
     if("episode" == game.activeScreen && (a || (a = window.event), 0 == a.button)) {
      ...
      game.loop ? (window.onmouseup = null, game.showMessage(game.curgameStr), window.onkeydown = function(a) {
       if(!a) a = window.event;
       switch(a.keyCode) {
        case 89:
        case 90:
         ...
         setTimeout(function() {
          window.onmouseup = function(a) {
           ...
           if(a.button != 0) {
            ...
            game.hideScreen("episode", game.loop ? game.gameMenu : game.menu)
           }
          };
          window.onkeydown = game.episodeCtrl
         }, 500);
 ...
 detail: function() {
  game.showScreen("detail", null, function() {
   ...
   window.onmouseup = function(a) {
    if("detail" == game.activeScreen && (a || (a = window.event), 0 != a.button)) window.onkeydown = window.onclick = null, audio.playSound("escpressed"), game.hideScreen("detail", game.loop ? game.gameMenu : game.menu)
   };
   for(var d = 0; d < c.length; d++) {
    ...
    if(d == b.cursorIndex)
     for(f = 0; f < e.length; f++) 0 > e[f].className.search("selected") && (e[f].className += " selected"), 0 == f ? game.largeSelected.text(e[f], (160 * (d + 1)).toString()) : 1 == f ? game.largeSelected.text(e[f], "x") : 2 == f && game.largeSelected.text(e[f], (120 * (d + 1)).toString());
    else
 ...
 sound: function() {
  game.showScreen("sound", null, function() {
   ...
   document.querySelector("#sound .soundoption .bar").onmouseup = function(a) {
    if("sound" == game.activeScreen && (a || (a = window.event), 0 == a.button)) {
     audio.playSound("movegun2");
 ...
 customizeCtrl: function(a) {
  ...
  switch(a.keyCode) {
   case 40:
    void 0 == b.posIndex || null == b.posIndex ? (audio.playSound("movegun2"), b.cursorIndex++, b.cursorIndex == c.length && (b.cursorIndex = 0)) : (audio.playSound("escpressed"), b.posIndex = null);
    game.customize();
    break;
   case 38:
   ...
   case 37:
    ...
    break;
   case 39:
    void 0 != b.posIndex && null != b.posIndex && (audio.playSound("movegun2"), b.posIndex++, 4 == b.posIndex && (b.posIndex = 0), game.customize());
    break;
   case 13:
    audio.playSound("shoot");
 ...
 customize: function() {
  game.showScreen("customize", null, function() {
   ...
   for(var d = 0; d < b.length; d++) {
    ...
    e[2].className = "text";
    e[3].className = "text";
    b[d] == b[a.cursorIndex] && void 0 != a.posIndex && null != a.posIndex && (e[a.posIndex].className = "text readme change");
   ...
   if(a.wait) {
    ...
    window.onkeydown = function(d) {
     ...
     if(game.keyNames[d.keyCode]) {
      ...
      else if(a.posIndex == 2) game.ctrl ? game.ctrl.keys.forward.keyCode = [d.keyCode] : controller.keys.forward.keyCode = [d.keyCode];
 ...
 newHighscore: function(a, b, c) {
  ...
  game.showScreen("highscores", null, function() {
   audio.playMusic("roster");
   var d = 0,
    e = localStorage.highscores ? JSON.parse(localStorage.highscores) : game.baseHighscores;
   e.sort(function(a, b) {
    var c = parseInt(a.score),
     d = b.score;
    return c < d ? 1 : c > d ? -1 : 0
   ...
   if(b < parseInt(e[6].score)) setTimeout(function() {
    ...
    window.onkeydown = function(a) {
     a || (a = window.event);
     var b = a.keyCode;
     if(i.children.length && 13 == b) window.onkeydown = null, audio.playSound("shoot"), n.style.display = "none", e.push({
      name: s,
      level: o,
      score: r
     }), e.sort(function(a, b) {
      ...
      if(15 > i.children.length && (32 == b || 47 < b && 91 > b || 105 < b && 112 > b && 108 != b || 185 < b && 193 > b || 218 < b && 223 > b)) {
       var d = "";
 ...
 newLoadGame: function(a) {
  game.newGame(a.mapName.slice(0, 3) + a.player.floor, a.difficulty, game.tick, function() {
   ...
   } - 1 < a.player.weapons.indexOf(3) && (b = new player.Weapon(wolf3d.utils.weapons.gatling), game.client.weapons.push(b), b = game.client.weapons[game.client.weapons.length - 1], b.animation && b.animation.callback && (b.animation.callback = utils.bind(game.client, b.animation.callback)));
   ...
   for(b = 0; b < a.doors.length; b++) {
    ...
    d && (d.slide = c.slide, d.delayTimer = c.delayTimer, d.action = c.action, c.process && ("open" == c.action ? d.close() : "close" == c.action && d.open(), audio.process.pop()))
   }
   ...
   for(b = 0; b < game.client.map.ai.length; b++)
    if(c = game.client.map.ai[b], d = a.ai[c.eval]) {
     c.x = d.x;
     c.y = d.y;
     c.baseX = d.baseX;
     c.baseY = d.baseY;
     ...
     for(var e in d.animations)
      if("object" == typeof d.animations[e]) {
       var f = c.animations[e],
        h = d.animations[e];
       f && (f.keyframe = h.keyframe, f.state = h.state, f.speed = h.speed, f.count = h.count, f.step = h.step, f.index = h.index, f.timer = h.timer, f.stopping = h.stopping, f.process = h.process ? f[h.process] : f.process, f.process && 0 > animation.process.indexOf(f) && animation.process.push(f))
      }
     delete a.ai[c.eval]
    }
 ...
 loadGameCtrl: function(a) {
  ...
  switch(a.keyCode) {
   ...
   case 38:
    audio.playSound("movegun1");
    b.cursorIndex--;
    0 > b.cursorIndex && (b.cursorIndex = game.slots.length - 1);
    game.loadGame();
    break;
   case 13:
    window.onkeydown = window.onclick = null;
    ...
    break;
   case 27:
    window.onkeydown = window.onclick = null, audio.playSound("escpressed"), game.hideScreen("loadgame", game.loop ? game.gameMenu : game.menu)
  }
 },
 loadGame: function() {
  game.showScreen("loadgame", null, function() {
   ...
   window.onkeydown != game.loadGameCtrl && setTimeout(function() {
 ...
 saveGameCtrl: function(a) {
  ...
  switch(a.keyCode) {
   ...
   case 13:
    audio.playSound("shoot");
    d ? (localStorage.slots = JSON.stringify(game.slots), game.slots = JSON.parse(localStorage.slots), c[b.cursorIndex].removeChild(d)) : (game.slots[b.cursorIndex] = game.newSaveGame(), d = document.createElement("DIV"), d.className = "textcursor", c[b.cursorIndex].appendChild(d));
    game.saveGame();
    break;
   case 27:
    audio.playSound("escpressed");
    ...
    break;
   case 8:
    d && game.slots[b.cursorIndex].name.length && (game.slots[b.cursorIndex].name = game.slots[b.cursorIndex].name.slice(0, game.slots[b.cursorIndex].name.length - 1), game.saveGame());
    break;
   default:
 ...
 saveGame: function() {
  game.showScreen("savegame", null, function() {
   ...
   for(var c = 0; c < b.length; c++) {
    ...
    d.className = game.slots[c] ? "text beforecursor" : "text small";
    d.innerHTML = "";
   ...
   window.onkeydown != game.saveGameCtrl && setTimeout(function() {
    ...
    c.onmousemove = function() {
     if(game.activeScreen == "gamemenu") {
      ...
      if(!(b[this.index].className.search("disabled") > -1 || a.cursorIndex == this.index)) {
       ...
       c.className = c.className.replace(" selected", "");
       c.className.search("readthis") < 0 ? game.largeText.text(c, game.gameMainMenu[a.cursorIndex]) : game.largeReadthis.text(c, game.gameMainMenu[a.cursorIndex]);
       a.cursorIndex = this.index;
       audio.playSound("movegun1");
       c = b[a.cursorIndex];
    ...
    c.onmouseup = function(a) {
     if(game.activeScreen == "gamemenu") {
      ...
      if(a.button === 0) {
       ...
       switch(this.index) {
        case 0:
         game.hideScreen("gamemenu", game.episode);
         break;
        case 1:
   ...
   game.showScreen(a, null, function() {
    setTimeout(function() {
     ...
     window.onmouseup = function(e) {
      e || (e = window.event);
      0 == e.button ? c.pageIndex < d.length - 1 ? (audio.playSound("movegun2"), c.pageIndex++, f(c.pageIndex)) : (audio.playSound("escpressed"), game.hideScreen(a, b)) : (audio.playSound("escpressed"), game.hideScreen(a, b))
     };
 ...
 init: function() {
  ...
  game.debug = a.debug;
  a.loadgame ? game.newLoadGame(JSON.parse(localStorage.slots)[a.loadgame]) : a.map ? game.newGame(a.map || "e1m1", parseInt(a.difficulty || "0"), game.tick) : (audio.playMusic("copypro"), game.showScreen(a.donation ? "donation" : "copyright", null, function() {
